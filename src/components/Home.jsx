        ...
        <div>
            ...
            <div className='flex items-center justify-center'>
                <div className="w-full sm:w-1/2 flex-col justify-center">
                    ...
                    <h2 className='text-4xl md:text-7xl font-bold text-orange-400 py-2'>Sam...</h2>
            ...
            <div className='flex flex-col mt-10 items-center justify-around sm:flex-row'>
                ...
                <div className='ml-4 mt-4 sm:mt-0'>
                    ...
                    <button className='button-style mt-2'> <a href="https://drive.google.com/file/d/1mnhGIsY6TF6RTlwjbugVA52NFPm_Iiha/view">Download CV</a> </button>
